    ...
    return (
        <div className="navbar bg-base-100 py-2">
            ...
            <div className="navbar-start">
                ...
                {/* Logo And Title */}
                <label tabIndex={0} className="btn btn-ghost btn-circle avatar p-0 hidden md:block">
                    <div className="w-10 rounded-full">
                        <img src={Logo} alt="" />
                    </div>
                </label>
                <Link to='/' className="btn btn-ghost normal-case text-xl p-0">Xplore</Link>
            </div>
            {/* Navbar Center */}
            ...
            <div className="navbar-end">
                ...
                <label className="swap swap-rotate mr-2">
                    <input type="checkbox" onClick={toogleThemes} />
                ...
                <label tabIndex={0} className="btn btn-ghost btn-circle avatar mr-2">
                    <div className="w-10 rounded-full">
                        {
                            user ? <img src={user?.photoURL} alt="" title={user?.displayName} />
                                :
                ...
                <>
                    {
                        user ? <Link to='/login' onClick={logOut} className='btn'>Sign Out</Link>
